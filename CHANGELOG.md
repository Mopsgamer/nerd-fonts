...
- BREAKING CHANGE: Replace `createRequire(json)` with `import json with { type: "json" }`.
- Setup oxc linter and formatter.
- Use GitHub Actions for publishing.
- Fix potential manifest issues.

## [0.4.1] - 2025-12-25

- Invalid release of 0.5.0.

## [0.4.0] - 2025-08-21

- Refactor `fromPath` API.
- `mappingsMeta` now includes `total`.

## [0.3.1] - 2025-07-03

- Upgrade NF from `3.3.0` to `3.4.0`.
- Use Bun for development.
- Fix fs export and mappings `out` folder duplication.

## [0.3.0] - 2025-02-06

- Upgrade NF from `3.2.1` to `3.3.0`.
